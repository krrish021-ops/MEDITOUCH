...
> **Use this document as a full prompt for an AI to redesign the app's theme, colors, typography, and visual style. Every screen, widget, navigation element, and data structure is documented below.**
